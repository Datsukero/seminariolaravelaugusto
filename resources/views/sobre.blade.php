...
-------------------------------------------------- */
  ...
  body {
    padding-top: padding-bottom: 3rem;
    color: #5a5a5a;
  }
...
<div class="py-5 container marketing">
  <div class="row featurette">
    ...
    <div class="col-md-5"><img class="featurette-image img-fluid mx-auto" src="media/laravel_logo.jpg" alt="Laravel Logo"></div>
  </div>
